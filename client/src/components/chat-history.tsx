      ...
      <div className="mt-auto p-2 border-t border-neutral-800">
        <DropdownMenu>
          ...
          <DropdownMenuContent 
            ...
            side="top"
            sideOffset={10} 
            className="w-[260px] bg-neutral-800 border border-neutral-700 text-white rounded-xl shadow-lg animate-in slide-in-from-bottom-5 fade-in-80 z-[9999] personal-menu-content"
          >
